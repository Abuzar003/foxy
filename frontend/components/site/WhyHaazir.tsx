    ...
    <section id="about" className="py-20 md:py-28">
      <div className="container">
        <div className="text-center max-w-2xl mx-auto">
          <span className="text-xs font-semibold uppercase tracking-widest text-teal">Why Haazir</span>
          <h2 className="mt-3 text-3xl md:text-4xl font-bold">Built on trust. Designed for speed.</h2>
        </div>
