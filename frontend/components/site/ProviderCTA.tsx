        ...
        <div className="relative overflow-hidden rounded-3xl border border-teal/30 bg-teal-gradient p-10 md:p-14 shadow-teal">
          ...
          <div className="relative grid md:grid-cols-[1.5fr_auto] gap-6 items-center">
            <div className="text-secondary-foreground">
              <h2 className="text-3xl md:text-4xl font-bold">Earn with Haazir — join 10,000+ pros</h2>
            ...
            <Button size="lg" className="bg-gold-gradient text-primary-foreground hover:opacity-90 shadow-gold font-semibold h-12 px-7">
