...
import { Sparkles, Globe2, MessageSquareShare, Share2, ExternalLink } from "lucide-react";
...
const cols = [
  ...
  {
    title: "Services",
    links: ["Electrician", "Plumber", "Painter", "Cleaning", "All services"],
  },
  {
    title: "Support",
        ...
        <div className="grid lg:grid-cols-[1.4fr_2fr] gap-12">
          <div>
            ...
            <form className="mt-6 flex gap-2 max-w-sm" onSubmit={(e) => e.preventDefault()}>
              <Input type="email" placeholder="your@email.com" className="h-11 bg-muted/60 border-border" />
              <Button className="h-11 bg-gold-gradient text-primary-foreground hover:opacity-90 font-semibold">Subscribe</Button>
            </form>

            <div className="mt-6 flex items-center gap-3">
              {[Globe2, MessageSquareShare, Share2, ExternalLink].map((Icon, i) => (
                <a
                  key={i}
                  href="#"
