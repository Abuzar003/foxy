    ...
    <main className="min-h-screen bg-gradient-to-b from-slate-50 via-white to-sky-50 px-6 py-12">
      <div className="mx-auto w-full max-w-lg">
        <div className="rounded-2xl border border-slate-200 bg-white/90 p-8 shadow-[0_14px_50px_rgba(15,23,42,0.08)] backdrop-blur">
          <h1 className="text-2xl font-semibold tracking-tight text-slate-900">Create your customer account</h1>
          <p className="mt-1 text-sm text-slate-500">Book verified pros for your home — one account for all your bookings.</p>
          ...
          <p className="mt-3 text-center text-sm text-slate-500">
            ...
            <Link href="/auth/signup/provider" className="font-medium text-slate-900 underline-offset-2 hover:text-sky-700">
