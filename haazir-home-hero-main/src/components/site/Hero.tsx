      ...
      <div className="container relative">
        <div className="max-w-3xl mx-auto text-center animate-fade-up">
          ...
          <h1 className="mt-6 text-4xl md:text-6xl font-bold tracking-tight leading-[1.05]">
            ...
            <span className="text-gradient-gold">Haazir</span> at your doorstep.
          </h1>

          <p className="mt-5 text-lg text-muted-foreground max-w-2xl mx-auto">
            Book electricians, plumbers, gardeners, drivers, painters and more —
            instantly or whenever you need.
          </p>
          ...
          <div className="mt-10 mx-auto max-w-3xl rounded-2xl bg-card-gradient border border-border p-3 shadow-soft">
            <div className="grid gap-3 md:grid-cols-[1.4fr_1fr_auto]">
              ...
              <Button
                size="lg"
                className="h-12 px-8 bg-gold-gradient text-primary-foreground hover:opacity-90 shadow-gold font-semibold"
              >
                Find a Pro
              </Button>
            </div>
